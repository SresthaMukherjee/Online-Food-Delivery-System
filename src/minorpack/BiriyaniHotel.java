...
import minorpack.FoodSelection;
 ...
 * @author Manager
 */
public class BiriyaniHotel extends javax.swing.JFrame {

    /**
     * Creates new form BiriyaniHotel
     */
    public BiriyaniHotel() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Not in Biriyani mood !!!");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BiriyaniHotel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BiriyaniHotel().setVisible(true);
            }
        });
    }
